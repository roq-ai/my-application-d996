  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to My Application - Your Gateway to Streamlined Employee Login and Efficient HRMS Portal Management."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxlbXBsb3llZXxlbnwwfHx8fDE2OTA3OTI1NTN8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to My Application - Your Gateway to Streamlined Employee Login and Efficient HRMS Portal Management.`}
            </Text>
            <Box
